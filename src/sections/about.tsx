        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="pt-6">
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="group inline-flex items-center gap-3 bg-[#ADFF2F] hover:bg-[#9AE234] text-black font-semibold px-6 py-3 rounded-full transition-all duration-300 hover:shadow-lg hover:shadow-[#ADFF2F]/25"
              >
          ...
          >
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-[#ADFF2F]/10 to-cyan-400/10 rounded-3xl blur-3xl transform -rotate-6 scale-110"></div>
              
              {/* Main component container */}
              <div className="relative bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-3xl p-12 md:p-16">
                <DesignCodeCookComponent />
                
                {/* Decorative corner elements */}
                <div className="absolute top-4 left-4 w-8 h-8 border-l-2 border-t-2 border-gray-700 rounded-tl-lg"></div>
                <div className="absolute top-4 right-4 w-8 h-8 border-r-2 border-t-2 border-gray-700 rounded-tr-lg"></div>
                <div className="absolute bottom-4 left-4 w-8 h-8 border-l-2 border-b-2 border-gray-700 rounded-bl-lg"></div>
                <div className="absolute bottom-4 right-4 w-8 h-8 border-r-2 border-b-2 border-gray-700 rounded-br-lg"></div>
              </div>
            </div>
          </motion.div>
