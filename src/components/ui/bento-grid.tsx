...
function BentoGrid({ items, className }: BentoGridProps) {
    return (
        <div className={cn("grid grid-cols-1 md:grid-cols-2 gap-6 max-w-7xl mx-auto", className)}>
                ...
                >
                    ...
                    <div className="relative flex flex-col space-y-4">
                        <div className="flex items-center justify-between">
                            ...
                            {item.status && (
                                <span className="text-xs font-medium px-3 py-1 rounded-full backdrop-blur-sm bg-white/10 text-gray-300 transition-colors duration-300 group-hover:bg-white/20">
                                    {item.status}
                                </span>
                            )}
                        </div>
