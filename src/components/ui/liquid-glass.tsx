...
// Navigation Item Component for the header
const GlassNavItem: React.FC<{ 
  children: React.ReactNode; 
  href?: string;
  onClick?: () => void;
  ...
  <GlassEffect
    href={href}
    className="rounded-2xl px-4 py-2 hover:px-5 hover:py-3 hover:rounded-3xl overflow-hidden"
  >
    <div
      className="transition-all duration-700 hover:scale-95 text-sm font-medium"
      style={{
        transitionTimingFunction: "cubic-bezier(0.175, 0.885, 0.32, 2.2)",
      }}
      onClick={onClick}
...
export { GlassEffect, GlassDock, GlassButton, GlassNavItem, GlassFilter };
