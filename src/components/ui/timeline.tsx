  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-3xl md:text-5xl lg:text-6xl mb-6 text-white max-w-4xl font-bold">
          My Journey Timeline
        </h2>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-black border-2 border-[#ADFF2F] flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-[#ADFF2F] border border-[#ADFF2F] p-2" />
              </div>
              <h3 className="hidden md:block text-xl md:pl-20 md:text-4xl lg:text-5xl font-bold text-[#ADFF2F]">
                {item.title}
              </h3>
            </div>

            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3 className="md:hidden block text-2xl mb-4 text-left font-bold text-[#ADFF2F]">
                {item.title}
              </h3>
              {item.content}
            </div>
